...
public class BookController {
    ...
    @GetMapping("magic/{category}")
    private List<Book> getBooksByCategoryMagic(@PathVariable("category") Long category){
        return bookService.getBooksByCategoryMagic(category);
    }
}
